...
data class GenomicFeature(val startChr: Chromosome, val startPos: Int, val endChr: Chromosome = startChr, val endPos: Int = startPos, val name: String? = null) : Comparable<GenomicFeature> {
