...
open class GenomicFactor(val factor: Factor, val startChr: Chromosome, val startPos: Int, val endChr: Chromosome = startChr, val endPos: Int = startPos) : Comparable<GenomicFactor> {
